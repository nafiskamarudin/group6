...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO film_actor (actor_id, film_id, last_update, film_actor_id) VALUES (%s, %s, %s, %s)",
...
<p align="center">&nbsp;</p>
<h1 align="center">ADD FILM ACTOR INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="actor_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="film_actor_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
