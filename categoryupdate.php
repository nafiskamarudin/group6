...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE category SET name=%s, last_update=%s WHERE category_id=%s",
...
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM category WHERE category_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <input type="hidden" name="category_id" value="<?php echo $row_Recordset1['category_id']; ?>" />
</form>
<p>&nbsp;</p>
<p align="center"><a href="category.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a> </p>
</body>
</html>
<?php
