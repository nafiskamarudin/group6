...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE inventory SET film_id=%s, store_id=%s, last_update=%s WHERE inventory_id=%s",
...
if (isset($_GET['inventory_id'])) {
  $colname_Recordset1 = $_GET['inventory_id'];
}
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM inventory WHERE inventory_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<p align="center">&nbsp;</p>
<h1 align="center">UPDATE INVENTORY INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_Recordset1['inventory_id']; ?></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="inventory_id" value="<?php echo $row_Recordset1['inventory_id']; ?>" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center"><a href="inventory.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a> </p>
</body>
</html>
<?php
