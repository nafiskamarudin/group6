...
$query_Recordset1 = "SELECT * FROM address";
...
<p align="center">&nbsp;</p>
<h1 align="center">ADDRESS INFORMATION</h1>
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        ...
        <td width="67"><h5>Address</h5></td>
        <td width="88"><h5>Address 2</h5></td>
        <td width="88"><h5>District</h5></td>
        <td width="88"><h5>City ID</h5></td>
        <td width="88"><h5>Postal Code</h5></td>
        <td width="88"><h5>Phone</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['postal_code']; ?></td>
          <td><?php echo $row_Recordset1['phone']; ?></td>
          <td><?php echo $row_Recordset1['last_update']; ?></td>
          <td><p> <a href="addressdelete.php?address_id=<?php echo $row_Recordset1['address_id']; ?>">delete </a>
          <p><a href="addressupdate.php?address_id=<?php echo $row_Recordset1['address_id']; ?>">update</a></td>
        </tr>
...
<p><a href="addressadd.php">ADD NEW DATA</a> </p>
