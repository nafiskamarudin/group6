...
$query_Recordset1 = "SELECT * FROM film_text";
...
<p align="center">&nbsp;</p>
<h1 align="center">FILM TEXT INFORMATION</h1>
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        ...
        <td width="67"><h5>Title</h5></td>
        <td width="88"><h5>Description</h5></td>
        <td width="88"><h5>Film ID</h5></td>
        <td width="67"><h5>Language ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="filmtextdelete.php?film_text_id=<?php echo $row_Recordset1['film_text_id']; ?>">delete </a>
          <p><a href="filmtextupdate.php?film_text_id=<?php echo $row_Recordset1['film_text_id']; ?>">update</a></td>
        </tr>
...
<p><a href="filmtextadd.php">ADD NEW DATA</a> </p>
