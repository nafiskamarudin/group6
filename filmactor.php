...
$query_Recordset1 = "SELECT * FROM film_actor";
...
<p align="center">&nbsp;</p>
<h1 align="center"> FILM ACTOR INFORMATION</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Film Actor ID</h5></td>
        <td width="88"><h5>Film ID</h5></td>
        <td width="88"><h5>Last Update</h5></td>
        <td width="67"><h5>Actor ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="filmactordelete.php?film_actor_id=<?php echo $row_Recordset1['film_actor_id']; ?>">delete </a>
          <p><a href="filmactorupdate.php?film_actor_id=<?php echo $row_Recordset1['film_actor_id']; ?>">update</a></td>
        </tr>
...
<p><a href="filmactoradd.php">ADD NEW DATA</a> </p>
