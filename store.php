  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        ...
        <td width="88"><h5>Manager Staff ID</h5></td>
        <td width="67"><h5>Address ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['manager_staff_id']; ?></td>
          <td><?php echo $row_Recordset1['address_id']; ?></td>
          <td><?php echo $row_Recordset1['last_update']; ?></td>
          <td><p> <a href="storedelete.php?store_id=<?php echo $row_Recordset1['store_id']; ?>">delete </a>
          <p><a href="storeupdate.php?store_id=<?php echo $row_Recordset1['store_id']; ?>">update</a></td>
        </tr>
...
<p><a href="storeadd.php">ADD NEW DATA</a> </p>
