...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Payment ID</h5></td>
        <td width="88"><h5>Customer ID</h5></td>
        <td width="67"><h5>Staff ID</h5></td>
		<td width="88"><h5>Rental ID</h5></td>
		<td width="88"><h5>Amount</h5></td>
		<td width="88"><h5>Payment Date</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="paymentdelete.php?payment_id=<?php echo $row_Recordset1['payment_id']; ?>">delete </a>
          <p><a href="paymentupdate.php?payment_id=<?php echo $row_Recordset1['payment_id']; ?>">update</a></td>
        </tr>
...
<p><a href="paymentadd.php">ADD NEW DATA</a> </p>
