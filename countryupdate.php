...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE country SET country=%s, last_update=%s WHERE country_id=%s",
...
if (isset($_GET['country_id'])) {
  $colname_Recordset1 = $_GET['country_id'];
}
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM country WHERE country_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<p align="center">&nbsp;</p>
<h1 align="center">UPDATE COUNTRY INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_Recordset1['country_id']; ?></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="country_id" value="<?php echo $row_Recordset1['country_id']; ?>" />
</form>
<p>&nbsp;</p>
<p align="center"><a href="country.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a> </p>
</body>
</html>
<?php
