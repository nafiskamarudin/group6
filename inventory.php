...
$query_Recordset1 = "SELECT * FROM inventory";
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Inventory ID</h5></td>
        <td width="67"><h5>Film ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="inventorydelete.php?inventory_id=<?php echo $row_Recordset1['inventory_id']; ?>">delete </a>
          <p><a href="inventoryupdate.php?inventory_id=<?php echo $row_Recordset1['inventory_id']; ?>">update</a></td>
        </tr>
...
<p><a href="inventoryadd.php">ADD NEW DATA</a> </p>
