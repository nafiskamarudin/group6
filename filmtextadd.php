...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO film_text (film_text_id, title, `description`, film_id, language_id) VALUES (%s, %s, %s, %s, %s)",
...
<p align="center">&nbsp;</p>
<h1 align="center">ADD FILM TEXT INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="film_text_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
