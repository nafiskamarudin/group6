...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE payment SET customer_id=%s, staff_id=%s, rental_id=%s, amount=%s, payment_date=%s, last_update=%s WHERE payment_id=%s",
...
if (isset($_GET['payment_id'])) {
  $colname_Recordset1 = $_GET['payment_id'];
}
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM payment WHERE payment_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<p align="center">&nbsp;</p>
<h1 align="center">UPDATE PAYMENT INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Payment_id:</td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="rental_id" value="<?php echo htmlentities($row_Recordset1['rental_id'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Payment_date:</td>
      <td><input type="text" name="payment_date" value="<?php echo htmlentities($row_Recordset1['payment_date'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="payment_id" value="<?php echo $row_Recordset1['payment_id']; ?>" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center"><a href="payment.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a> </p>
</body>
</html>
<?php
