...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO store (store_id, manager_staff_id, address_id, last_update) VALUES (%s, %s, %s, %s)",
...
<p align="center">&nbsp;</p>
<h1 align="center">ADD STORE INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="manager_staff_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
