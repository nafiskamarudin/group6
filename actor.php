...
$query_Recordset1 = "SELECT * FROM actor";
    ...
    <table width="1500" height="151" border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="actordelete.php?actor_id=<?php echo $row_Recordset1['actor_id']; ?>">delete </a>
          <p><a href="actorupdate.php?actor_id=<?php echo $row_Recordset1['actor_id']; ?>">update</a></td>
        </tr>
...
<p><a href="actoradd.php">ADD NEW DATA</a> </p>
