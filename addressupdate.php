...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE address SET address=%s, address2=%s, district=%s, city_id=%s, postal_code=%s, phone=%s, last_update=%s WHERE address_id=%s",
...
if (isset($_GET['address_id'])) {
  $colname_Recordset1 = $_GET['address_id'];
}
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM address WHERE address_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<p align="center">&nbsp;</p>
<h1 align="center">UPDATE ADDRESS INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_Recordset1['address_id']; ?></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="address2" value="<?php echo htmlentities($row_Recordset1['address2'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">District:</td>
      <td><input type="text" name="district" value="<?php echo htmlentities($row_Recordset1['district'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">City_id:</td>
      <td><input type="text" name="city_id" value="<?php echo htmlentities($row_Recordset1['city_id'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Postal_code:</td>
      <td><input type="text" name="postal_code" value="<?php echo htmlentities($row_Recordset1['postal_code'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="address_id" value="<?php echo $row_Recordset1['address_id']; ?>" />
</form>
<p>&nbsp;</p>
