...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `language` (language_id, name, last_update, film_text_id) VALUES (%s, %s, %s, %s)",
...
<p align="center">&nbsp;</p>
<h1 align="center">ADD LANGUAGE INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center"><a href="language.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a> </p>
</body>
</html>