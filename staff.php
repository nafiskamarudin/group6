...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Staff ID</h5></td>
        <td width="88"><h5>First Name</h5></td>
        <td width="67"><h5>Last Name</h5></td>
		<td width="88"><h5>Address ID</h5></td>
		<td width="88"><h5>Picture</h5></td>
		<td width="88"><h5>Email</h5></td>
		<td width="88"><h5>Store ID</h5></td>
		<td width="88"><h5>Active</h5></td>
		<td width="88"><h5>Username</h5></td>
		<td width="88"><h5>Password</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['picture']; ?></td>
          <td><?php echo $row_Recordset1['email']; ?></td>
          <td><?php echo $row_Recordset1['store_id']; ?></td>
          <td><?php echo $row_Recordset1['active']; ?></td>
          <td><?php echo $row_Recordset1['username']; ?></td>
          <td><?php echo $row_Recordset1['password']; ?></td>
          <td><?php echo $row_Recordset1['last_update']; ?></td>
          <td><p> <a href="staffdelete.php?staff_id=<?php echo $row_Recordset1['staff_id']; ?>">delete </a>
          <p><a href="staffupdate.php?staff_id=<?php echo $row_Recordset1['staff_id']; ?>">update</a></td>
        </tr>
...
<p><a href="staffadd.php">ADD NEW DATA</a> </p>
