...
$query_Recordset1 = "SELECT * FROM film";
...
<p align="center">&nbsp;</p>
<h1 align="center">FILM INFORMATION</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Film ID</h5></td>
        <td width="88"><h5>Title</h5></td>
        <td width="67"><h5>Description</h5></td>
        <td width="88"><h5>Release Year</h5></td>
        <td width="88"><h5>Language ID</h5></td>
        <td width="88"><h5>Original Language ID</h5></td>
        <td width="88"><h5>Rental Duration</h5></td>
        <td width="88"><h5>Rental Rate</h5></td>
        <td width="88"><h5>Length</h5></td>
        <td width="88"><h5>Replacement Cost</h5></td>
        <td width="88"><h5>Rating</h5></td>
        <td width="88"><h5>Special Features</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['release_year']; ?></td>
          <td><?php echo $row_Recordset1['language_id']; ?></td>
          <td><?php echo $row_Recordset1['original_language_id']; ?></td>
          <td><?php echo $row_Recordset1['rental_duration']; ?></td>
          <td><?php echo $row_Recordset1['rental_rate']; ?></td>
          <td><?php echo $row_Recordset1['length']; ?></td>
          <td><?php echo $row_Recordset1['replacement_cost']; ?></td>
          <td><?php echo $row_Recordset1['rating']; ?></td>
          <td><?php echo $row_Recordset1['special_features']; ?></td>
          <td><?php echo $row_Recordset1['last_update']; ?></td>
          <td><p> <a href="filmdelete.php?film_id=<?php echo $row_Recordset1['film_id']; ?>">delete </a>
          
          <p><a href="filmupdate.php?film_id=<?php echo $row_Recordset1['film_id']; ?>">update</a></td>
        </tr>
...
<p><a href="filmadd.php">ADD NEW DATA</a> </p>
