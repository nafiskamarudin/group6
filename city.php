...
$query_Recordset1 = "SELECT * FROM city";
    ...
    <table width="1500" height="151" border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="citydelete.php?city_id=<?php echo $row_Recordset1['city_id']; ?>">delete </a>
          <p><a href="cityupdate.php?city_id=<?php echo $row_Recordset1['city_id']; ?>">update</a></td>
        </tr>
...
<p><a href="cityadd.php">ADD NEW DATA</a> </p>
