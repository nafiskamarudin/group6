...
$query_Recordset1 = "SELECT * FROM film_category";
...
<p align="center">&nbsp;</p>
<h1 align="center">FILM CATEGORY INFORMATION</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Film Category ID</h5></td>
        <td width="88"><h5>Category ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="filmcategorydelete.php?film_category_id=<?php echo $row_Recordset1['film_category_id']; ?>">delete </a>
          <p><a href="filmcategoryupdate.php?film_category_id=<?php echo $row_Recordset1['film_category_id']; ?>">update</a></td>
        </tr>
...
<p><a href="filmcategoryadd.php">ADD NEW DATA</a> </p>
