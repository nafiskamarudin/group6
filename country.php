...
$query_Recordset1 = "SELECT * FROM country";
...
<p align="center">&nbsp;</p>
<h1 align="center">COUNTRY INFORMATION</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Country ID</h5></td>
        <td width="67"><h5>Country</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="countrydelete.php?country_id=<?php echo $row_Recordset1['country_id']; ?>">delete </a>
          <p><a href="countryupdate.php?country_id=<?php echo $row_Recordset1['country_id']; ?>">update</a></td>
        </tr>
...
<p><a href="countryadd.php">ADD NEW DATA</a> </p>
