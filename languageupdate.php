...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE `language` SET name=%s, last_update=%s, film_text_id=%s WHERE language_id=%s",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['last_update'], "date"),
                       GetSQLValueString($_POST['film_text_id'], "text"),
...
if (isset($_GET['language_id'])) {
  $colname_Recordset1 = $_GET['language_id'];
}
mysql_select_db($database_cousework_2, $cousework_2);
$query_Recordset1 = sprintf("SELECT * FROM `language` WHERE language_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<p align="center">&nbsp;</p>
<h1 align="center">UPDATE LANGUAGE INFORMATION</h1>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="film_text_id" value="<?php echo htmlentities($row_Recordset1['film_text_id'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="language_id" value="<?php echo $row_Recordset1['language_id']; ?>" />
</form>
<p><a href="language.php"><img src="image/back-button.png" alt="" width="83" height="34" /></a></p>
</body>
</html>
<?php
