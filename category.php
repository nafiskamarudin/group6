    ...
    <table width="1500" height="151" border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="categorydelete.php?category_id=<?php echo $row_Recordset1['category_id']; ?>">delete </a>
          <p><a href="categoryupdate.php?category_id=<?php echo $row_Recordset1['category_id']; ?>">update</a></td>
        </tr>
...
<p><a href="categoryadd.php">ADD NEW DATA</a> </p>
