  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        ...
        <td width="67"><h5>First Name</h5></td>
		<td width="88"><h5>Last Name</h5></td>
		<td width="88"><h5>Email</h5></td>
		<td width="88"><h5>Address ID</h5></td>
		<td width="88"><h5>Active</h5></td>
		<td width="88"><h5>Create ID</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><p> <a href="customerdelete.php?customer_id=<?php echo $row_Recordset1['customer_id']; ?>">delete </a>
          <p><a href="customerupdate.php?customer_id=<?php echo $row_Recordset1['customer_id']; ?>">update</a></td>
        </tr>
...
<p><a href="customeradd.php">ADD NEW DATA</a> </p>
