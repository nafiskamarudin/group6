...
$query_Recordset1 = "SELECT * FROM rental";
...
<p align="center">&nbsp;</p>
<h1 align="center">RENTAL INFORMATION</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="1500" height="151" border="1">
      <tr>
        <td width="88"><h5>Rental ID</h5></td>
        <td width="88"><h5>Rental Date</h5></td>
        <td width="67"><h5>Inventory ID</h5></td>
		<td width="88"><h5>Customer ID</h5></td>
		<td width="88"><h5>Return Date</h5></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['rental_date']; ?></td>
          <td><?php echo $row_Recordset1['inventory_id']; ?></td>
          <td><?php echo $row_Recordset1['customer_id']; ?></td>
          <td><?php echo $row_Recordset1['return_date']; ?></td>
          <td><?php echo $row_Recordset1['staff_id']; ?></td>
          <td><?php echo $row_Recordset1['last_update']; ?></td>
          <td><p> <a href="rentaldelete.php?rental_id=<?php echo $row_Recordset1['rental_id']; ?>">delete </a>
          <p><a href="rentalupdate.php?rental_id=<?php echo $row_Recordset1['rental_id']; ?>">update</a></td>
        </tr>
...
<p><a href="rentaladd.php">ADD NEW DATA</a> </p>
